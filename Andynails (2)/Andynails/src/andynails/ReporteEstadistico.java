...
public class ReporteEstadistico {
    ...
    public static void generarPDF() {
        ...
        try {
            ...
            // Personalizar colores de la gráfica 🎨
            PiePlot plot = (PiePlot) chart.getPlot();
            plot.setSectionPaint("Maquillaje", new java.awt.Color(255, 182, 193)); // Rosa claro
            plot.setSectionPaint("Uñas", new java.awt.Color(255, 215, 0)); // Dorado
            plot.setSectionPaint("Peinado", new java.awt.Color(173, 216, 230)); // Azul pastel
            ...
            String rutaPDF = "Reporte_Estadistico_Servicios.pdf";
            PdfWriter.getInstance(document, new FileOutputStream(rutaPDF));
            document.open();

            document.add(new Paragraph("Reporte Estadístico de Servicios más Solicitados"));
            document.add(new Paragraph(" "));
            document.add(new Paragraph("Gráfico generado con base en los datos actuales de la base de datos."));
            document.add(new Paragraph(" "));
