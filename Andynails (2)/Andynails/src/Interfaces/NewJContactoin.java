 ...
 * @author User
 */
public class NewJContactoin extends javax.swing.JFrame {
...
// Para obtener datos del usuario
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJContactoin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJContactoin().setVisible(true);
            }
        });
    }
